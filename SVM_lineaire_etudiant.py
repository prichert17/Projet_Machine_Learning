...
print('valeur des alphas :',svc.dual_coef_)
#Valeur de a0
print('valeur de ao :' ,svc.intercept_)
# Calcul à la main de a0

intercept=-1-(np.sum(sv[0,:]*sv[0,:])*svc.dual_coef_[0,0]+np.sum(sv[0,:]*sv[1,:])*svc.dual_coef_[0,1])
print('vérification a0: ', intercept)
